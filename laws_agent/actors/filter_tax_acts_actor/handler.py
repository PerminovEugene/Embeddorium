...
from laws_agent.parsers.xml_parser import extract_act_title
from laws_agent.storage.sql.sql_store import SqlStore

logger = logging.getLogger(__name__)


def filter_tax_acts(*, crawl_target_id: str, group: str, store: SqlStore) -> None:
    ...
    if not is_tax_related(title, text=fetch.raw_content):
        logger.info(
