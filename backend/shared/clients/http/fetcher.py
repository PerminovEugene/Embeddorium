...
from backend.shared.clients.http.failures import (
    FailureKind,
    FetchFailure,
    classify_status,
)
...
class HttpFetcher:
    ...
    def fetch(
        ...
        *,
        ...
        # Per-call read-timeout override (from the fetch_source actor config);
        # the connect timeout stays at the instance default.
