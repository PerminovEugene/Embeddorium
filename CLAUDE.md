...
At the end of every coding task, before the final response, update `.claude/commit-context.md`.
...
Do not include .claude/commit-context.md itself in git commits.
